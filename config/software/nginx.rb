...
source url: "http://openresty.org/download/ngx_openresty-#{version}.tar.gz", md5: "2d4410fa370d954a57705092fa7b1fc5"
...
build do
  ...
  command "patch -p1 < #{source_dir}/ngx_http_filter_cache/core.diff", cwd: "#{project_dir}/bundle/nginx-1.4.1"
  command "patch -p1 < #{source_dir}/nginx_upstream_check_module/check_1.2.6+.patch",  cwd: "#{project_dir}/bundle/nginx-1.4.1"
